...
export default function Alumni() {
  ...
  // Filter alumni (graduation year less than authUser)
  const alumni = users.filter(user => user.graduationYear < new Date().getFullYear());
  ...
  return (
    <div className="p-6 h-full flex flex-col bg-base-100">
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-base-content">Alumni</h2>
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin">
            {filteredAlumni.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-base-content">No alumni found</h3>
