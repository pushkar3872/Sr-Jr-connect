...
const FindTeammatePageSkeleton = () => {
  // Create an array of 10 placeholder items for the skeleton grid
  ...
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      <div className="flex justify-center items-center mb-6 space-x-4">
        <div className="h-12 bg-gray-200 rounded w-full max-w-md animate-pulse"></div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {skeletonItems.map((_, index) => (
          <div key={index} className="h-72 bg-gray-100 rounded-lg p-4 animate-pulse shadow-lg">
